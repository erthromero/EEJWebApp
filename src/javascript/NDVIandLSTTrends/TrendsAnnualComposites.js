...
// This code takes median composites at 1-year intervals
...
var cloudMask457_C2 = function(image) {
  ...
  Export.image.toDrive({image: NDVILinFit, description: 'NDVILinearFit1yr1990to2020',
                  folder: "EEJSpatialTrendRasters", scale: 30 , region: ext_geom ,
                  maxPixels:1e13});
  
  // NOTE (Eric): Export LST Trends to Google Drive
  
  Export.image.toDrive({image: LSTLinFit, description: 'LSTLinearFit1yr1990to2020',
  ...
  Export.image.toDrive({image: collection_ndvi, description: 'NDVI1yrTimeSeries1990to2020',
                  folder: "EEJSpatialTrendRasters", scale: 30 , region: ext_geom ,
                  maxPixels:1e13});
  
  // NOTE (Eric): Export LST image collection as multi-band single raster
  
  Export.image.toDrive({image: collection_lst, description: 'LST1yrTimeSeries1990to2020',
                  folder: "EEJSpatialTrendRasters", scale: 120 , region: ext_geom ,
                  maxPixels:1e13});
