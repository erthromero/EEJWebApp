...
// This code takes median composites at 3-year intervals for the months of July to October
...
var cloudMask457_C2 = function(image) {
  ...
  Export.image.toDrive({image: NDVILinFit, description: 'NDVILinearFit3yr1990to2020JulyOct',
                  folder: "EEJSpatialTrendRasters", scale: 30 , region: ext_geom ,
                  maxPixels:1e13});
  
  // NOTE (Eric): Export LST Trends to Google Drive
  
  Export.image.toDrive({image: LSTLinFit, description: 'LSTLinearFit3yr1990to2020JulyOct',
  ...
  Export.image.toDrive({image: collection_ndvi, description: 'NDVI3yrTimeSeries1990to2020JulyOct',
                  folder: "EEJSpatialTrendRasters", scale: 30 , region: ext_geom ,
                  maxPixels:1e13});
  
  // NOTE (Eric): Export LST image collection as multi-band single raster
  
  Export.image.toDrive({image: collection_lst, description: 'LST3yrTimeSeries1990to2020JulyOct',
                  folder: "EEJSpatialTrendRasters", scale: 120 , region: ext_geom ,
                  maxPixels:1e13});
